...
const char kLicenseActivatorService[] = "com.deepin.license";
const char kLicenseActivatorPath[] = "/com/deepin/license/Info";
const char kLicenseActivatorInterface[] = "com.deepin.license.Info";
