...
#ifndef SYS_LASTORE_JOB_INTERFACE_H
#define SYS_LASTORE_JOB_INTERFACE_H
 ...
 */
class SysLastoreJobInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    SysLastoreJobInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);

    ~SysLastoreJobInterface();
